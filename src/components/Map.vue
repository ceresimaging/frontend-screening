      ...
      layerOptions: {
        ...
        paint: {
          "circle-radius": [
            ...
            ["get", "mag"],
            0,
            ["interpolate", ["linear"], ["get", "mag"], 1, 1, 2, 4],
            3,
            ["interpolate", ["linear"], ["get", "mag"], 1, 4, 6, 8],
            4,
            ["interpolate", ["linear"], ["get", "mag"], 1, 6, 8, 10],
            5,
            ["interpolate", ["linear"], ["get", "mag"], 1, 8, 10, 14],
            6,
            ["interpolate", ["linear"], ["get", "mag"], 1, 10, 12, 16],
          ],
